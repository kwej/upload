...
public class MyReservationDetailController {
	...
	private final String command = "myRDetail.gt";
	...
	public void detail(@RequestParam("gno") int gno,
		...
		System.out.println("myReservationDetailController");
		...
		if(pb != null) {
			...
			String photo = pb.getPhoto().split(",")[0];
			
			pbAll += "*" + imgurl+photo + "*" + pb.getCheckin() + "*" + pb.getCheckout() + "*" + pb.getAdult() + "*" + pb.getKid() + "*" + pb.getName();
 		}
