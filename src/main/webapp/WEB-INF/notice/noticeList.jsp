...
<div class="container">
	<div class="row justify-content-center align-items-center">
		<div class="col-lg-9 text-center">
			<h1>
				<a href="nlist.nt">NOTICE</a>
			</h1>
		</div>
		<div class="col-sm-12 col-xl-12">
			<div class="m-n2" align="right">
				<button type="button" class="btn btn-primary m-2"
					onclick="location.href='nwrite.nt'">글쓰기</button>
			</div>
		</div>
			...
			<tbody>
				<c:forEach var="n" items="${lists }">
					<tr
						...
						<td><a
							href="ndetail.nt?nno=${n.nno}&pageNumber=${pageInfo.pageNumber}"><b>[${n.cate}]</b>
								${n.title }</a></td>
						<td width=25%><fmt:formatDate value="${n.nt_date }"
		...
		<!-- Bordered Table -->
		<br>
		<form action="nlist.nt" method="post" align="center">
           <div class="right">
