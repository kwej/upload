  ...
  <div class="container">
    <div class="row justify-content-center align-items-center">
      <div class="col-lg-9 text-center mt-5">
        <h1 class="heading" data-aos="fade-up">호스트 로그인</h1>
...
<div class="col-md-6 col-12 center">
	<div class="card">
	    ...
	    <div class="card-content">
	        <div class="card-body">
	            <form class="form form-vertical" action="login.ht" method="post" >
	                <div class="form-body">
	                    <div class="row">
	                        <div class="col-12">
	                            <div class="form-group has-icon-left">
	                                ...
	                                <div class="position-relative">
	                                    <input type="text" class="form-control" name="email" value="host@naver.com"
...
<div class="col-12 center2">
    <span>계정이 없으신가요?</span> &nbsp; <a href="join.ht"><span>회원가입</span></a>
</div>
<div class="col-12 center2">
    <a href="findid.ht"><span>이메일 찾기</span></a> &nbsp;<span> | </span>&nbsp; <a href="findpw.ht"><span>비밀번호 찾기</span></a>
</div>
