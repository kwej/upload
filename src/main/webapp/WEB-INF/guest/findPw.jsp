...
<head>
    ...
    <title>Semicolon Guest_FindPw page</title>
  ...
  <div class="container">
    <div class="row justify-content-center align-items-center">
      <div class="col-lg-9 text-center mt-5">
        <h1 class="heading" data-aos="fade-up">게스트 비밀번호 찾기</h1>
        ...
        >
          <ol class="breadcrumb text-center justify-content-center">
            <li class="breadcrumb-item"><a href="login.gt">Login</a></li>
            <li
...
<div class="col-xxl">
	<div class="card">
	    ...
	    <div class="card-content">
	        <div class="card-body">
	            <form class="form form-vertical" action="findpw.gt" method="post">
	                <div class="form-body">
	                    <div class="row">
	                        <div class="col-12">
	                            ...
	                            <div class="form-group has-icon-left">
	                                ...
	                                <div class="position-relative">
	                                    <input type="email" class="form-control" name="email"
	                                        placeholder="이메일을 입력하세요" id="email-id-icon" required>
	                                    <div class="form-control-icon">
	                        ...
	                        <button type="submit"
	                                class="btn btn-primary full_width">비밀번호 찾기</button>
							</div>
	                    </div>
	                </div>
	            </form>
