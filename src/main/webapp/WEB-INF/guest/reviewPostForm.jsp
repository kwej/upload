  ...
  <div class="container">
    <div class="row justify-content-center align-items-center">
      <div class="col-lg-9 text-center mt-5">
        <h1 class="heading" data-aos="fade-up">리뷰 등록</h1>
...
<div class="container">
	...
	<br>
	<form:form commandName="review" action="reviewpost.rv" name="myform" method="post">
		<div class="form-group">
			<div class="form-group">
				<input type="hidden" name="pno" value="${pb.pno }"> 
				<input type="hidden" name="house_no" value="${pb.house_no }"> 
				<input type="hidden" name="gno" value="${pb.gno}">
				<input type="hidden" name="checkin" value="${pb.checkin}">
				<input type="hidden" name="checkout" value="${pb.checkout}">
				
				<label for="name"><b>숙소명</b></label> <input type="text" class="form-control" name="name" value="${pb.name }" readonly/><br>
			</div>
			<div class="form-group">
				<label for="name"><b>숙박 기간</b></label> <input type="text" class="form-control" value="${pb.checkin } ~ ${pb.checkout }" readonly/><br>
			</div>
