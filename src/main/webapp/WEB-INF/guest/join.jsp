...
<head>
    ...
    <title>Semicolon Guest_Join page</title>
  ...
  <div class="container">
    <div class="row justify-content-center align-items-center">
      <div class="col-lg-9 text-center mt-5">
        <h1 class="heading" data-aos="fade-up">게스트 회원가입</h1>
...
<div class="col-xxl">
	<div class="card">
	    ...
	    <div class="card-content">
	        <div class="card-body">
	            <form:form commandName="guest" class="form form-vertical" action="join.gt" method="post">
	                <div class="form-body">
	                    <div class="row">
	                    	<div class="col-12">
	                        ...
	                        <div class="col-12">
	                            <div class="form-group has-icon-left">
	                                ...
	                                <div class="position-relative">
	                                    <input type="tel" class="form-control" name="phone" value="${guest.phone }"
