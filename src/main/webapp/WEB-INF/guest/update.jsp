      ...
      <div class="card mb-4">
        ...
        <c:if test="${kakaoGuest != null}">
          <form action="kakaoUpdate.gt" method="post">
            <div class="row mb-3">
              <label class="col-sm-2 col-form-label font vertical" for="basic-icon-default-fullname">이름</label>
              <div class="col-sm-10">
            ...
            <div class="row mb-3">
              <label class="col-sm-2 col-form-label font" for="basic-icon-default-phone">전화번호</label>
              <div class="col-sm-10">
                <div class="input-group input-group-merge">
          ...
          <form:form commandName="normalGuest" action="update.gt" method="post">
            ...
            <div class="row mb-3">
              <label class="col-sm-2 col-form-label font" for="basic-icon-default-password">현재 비밀번호</label>
              <div class="col-sm-10">
                <div class="input-group input-group-merge">
            ...
            <div class="row mb-3">
              <label class="col-sm-2 col-form-label font" for="basic-icon-default-new-password">새로운 비밀번호</label>
              <div class="col-sm-10">
                <div class="input-group input-group-merge">
