...
<html lang="en">
  ...
  <!-- 상단바 끝나는 부분 -->
	...
	<div class="container">
		...
		<br><br>
     		 <form:form  commandName="bee" action="bupdate.bo" method="post">
     		 <input type="hidden" name="pageNumber" value="${pageNumber }">
			 <input type="hidden" name="bno" value="${bee.bno }">
			 
			 <!-- 넘길거 반드시 넘기기. 헷갈려도 할때 집중해서 하기. -->
               <div class="row">
                  <div class="col-6">
                ...
                <br>
                <br><br>
                <button type="submit" class="btn btn-primary-hover-outline">수정하기</button> &nbsp; &nbsp; &nbsp; &nbsp;
